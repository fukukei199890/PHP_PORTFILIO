            ...
            <div class="bg-white border border-gray-200 rounded-2xl p-5 shadow-sm">
                ...
                <div class="mb-4">
                    ...
                    <div class="bg-gray-50 rounded-lg p-3 text-center">
                        @if($row->image_url)
                        <img src="{{ asset('storage/' . $row->image_url) }}" class="mx-auto h-40 object-contain rounded-md shadow-sm">
                        @else
                ...
                <div class="mb-4">
                    ...
                    <div class="bg-gray-50 rounded-lg p-3 text-center mb-2">
                        ...
                        <img src="{{ asset('storage/' . ($row->listed_item->images->first()->image_url ?? $row->listed_item->images->first()->path)) }}" class="mx-auto h-40 object-contain rounded-md shadow-sm">
                        @else
                        <div class="h-40 flex items-center justify-center bg-gray-200 rounded-md">
                            <p class="text-xs text-gray-400">画像なし</p>
                        </div>
