...
<body>
    ...
    <div class="container">
        ...
        <ul>
            ...
            <li>電話番号</li>
            <li>IPアドレス</li>
            <li>Cookieおよびアクセス解析情報</li>
        </ul>

        <h2 class="bg-blue-500">2. 利用目的</h2>
        <ul>
            <li>サービスの提供および運営</li>
            <li>お問い合わせ対応</li>
            <li>不正利用の防止</li>
        ...
        <h2>4. Cookieの利用</h2>
        <p>当サイトでは、サービス向上のためCookieを利用する場合があります。</p>

        <h2>5. 安全管理措置</h2>
        <p>当社は、個人情報の漏えい、滅失、毀損の防止のため適切な安全管理措置を講じます。</p>

        <h2>6. 開示・訂正・削除</h2>
        <p>ユーザーは、自己の個人情報について開示・訂正・削除を求めることができます。</p>
