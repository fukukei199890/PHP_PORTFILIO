            ...
            <div class="bg-white hover:bg-gray-50 transition-colors px-6 py-5 flex items-center gap-4">
                ...
                <div class="flex-1 min-w-0">
                    <div class="flex justify-between items-baseline mb-1">
                        ...
                        <span class="text-[10px] text-gray-400 font-medium px-2 py-0.5 border border-gray-200 rounded-full uppercase">
                            Matching
                        </span>
                    </div>
                ...
                <form method="post" action="{{ route('startTalk') }}" class="shrink-0">
                    ...
                    <button class="bg-gray-900 text-white text-xs font-bold px-4 py-2 rounded-lg shadow-sm
