<x-user-layout>
    <div class="max-w-md mx-auto min-h-screen bg-white pb-24">
        ...
        <div class="grid grid-cols-2 gap-3 px-6 mb-10">
            ...
            {{-- 取引完了ボタン --}}
            <a href="{{ route('itemcomplete') }}" class="bg-white border border-gray-900 text-gray-900 text-center py-5 rounded-2xl text-sm font-bold hover:bg-gray-50 transition shadow-sm flex flex-col items-center gap-1">
                <span class="text-xs text-gray-400 font-normal italic"></span>
                取引完了
            </a>
        </div>
        ...
        <div class="px-4 border-t border-gray-100">
            ...
            <a href="{{ route('manual') }}" class="flex items-center justify-between py-5 border-b border-gray-50 px-4 hover:bg-gray-50 group">
